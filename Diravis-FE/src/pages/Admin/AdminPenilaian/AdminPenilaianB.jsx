...
const AdminPenilaianB = () => {
  ...
  const fetchData = async () => {
    const response = await axios
      .get(`http://localhost:8000/api/kibb/all/penilaian/${location.state}`)
  ...
  const openDetails = (data) => {
    navigate(`/admin/penilaian/detail/kib-b/${data.id_usulan_b}`, {
      state: data,
    });
  };
...
export default AdminPenilaianB;
