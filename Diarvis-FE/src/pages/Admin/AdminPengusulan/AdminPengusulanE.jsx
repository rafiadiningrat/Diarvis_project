...
const AdminPengusulanE = () => {
  ...
  const fetchData = async () => {
    const response = await axios
      .get(`http://localhost:8000/api/kibe/penilaian/${location.state}`)
  ...
  const openDetails = (data) => {
    navigate(`/admin/pengusulan/detail/kib-e/${data.id_usulan_e}`, {
      state: data,
    });
  };
...
export default AdminPengusulanE;
