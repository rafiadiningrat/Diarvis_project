...
const TerverifikasiE = () => {
  ...
  const fetchData = async () => {
    const response = await axios
      .get(`http://localhost:8000/api/kibe/all/verifikasi/${codeFilterUpb}`)
  ...
  const openDetails = (data) => {
    navigate(`/terverifikasi/kib-e/detail/${data.id_usulan_e}`, {
      state: data,
    });
  };
